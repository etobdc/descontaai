...
class CreateDescontosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Descontos", 'descontos', 'titulo', 'fa-dollar', [
            ["titulo", "Título", "TextField", false, "", 0, 256, true],
            ["descricao", "Descrição", "Textarea", false, "", 0, 0, true],
        ]);
